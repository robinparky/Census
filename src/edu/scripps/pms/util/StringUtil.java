...
/**
 * @author  Robin Park
 * @version $Id: StringUtil.java,v 1.1 2007/03/14 00:38:04 rpark Exp $
 */
public class StringUtil
{
  public static String getGene(String desc) {

    String gene = desc.substring(desc.indexOf("GN=")+3);
    return gene.substring(0, gene.indexOf(" "));
    ...
    */
    ...
    {
	System.out.println( StringUtil.trimAccession("fdsafdsa 99fdsaffdsafdsaffdsafdsafsdafdsdfffffffffffffffddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddfsdafds", 70) );
