...
public class Fisher
{
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        l.add(new  Double("0.0000001"));
        
        l.add(new  Double("0.0"));
        System.out.println("===" + Fisher.combinedProbabilityTest(l));
...
*/
    ...
    public static double combinedProbabilityTest(List<Double> arr) {
        double xsq = 0;
        for(double d:arr) {
                xsq += Math.log(d);
        }
        ...
        ChiSquaredDistribution cs = new ChiSquaredDistribution(2*arr.size());
        double pvalue = 1-cs.cumulativeProbability(xsq);
