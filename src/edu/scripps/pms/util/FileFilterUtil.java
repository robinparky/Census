 ...
 *
 * @author Robin Park
 * @version $Id: FileFilterUtil.java,v 1.2 2009/03/13 21:55:36 rpark Exp $
 */
...
//                return file.isFile();
    ...
    public static FileFilter getFiles(final String extension)
    {
        return new FileFilter()
        {
            public boolean accept(File file)
...
//                 System.out.println("got file: " + s);
    ...
    private static ArrayList<String> getMs2Files(String f) {
    ...
    public static void copyfiles(String sourceFolder, String targetFolder,
                                 String suffix) throws IOException, java.lang.InterruptedException {
...
*/
    public static void makeRelativeSymbolicLinks(String sourceFolder, String targetFolder,
                                                 String suffix, String relativePath) throws IOException, java.lang.InterruptedException {
/*
	File f = new File(targetFolder);
	if(!f.exists())
	    f.mkdir();
...
*/
    ...
    public static void makeRelativeSymbolicLinks(String sourceFolder, String targetFolder,
                                                 String suffix, String relativePath, String prefixtoadd) throws IOException, java.lang.InterruptedException {
...
//System.out.println("Exit value of " + lncommand + " command is " + p.exitValue());
    ...
    public static void makeSymbolicLink(String sourceFolder, String targetFolder, String sourceFile, String targetFile) throws IOException, java.lang.InterruptedException {
    ...
    public static void makeSymbolicLink(String sourceFolder, String targetFolder, String file) throws IOException, java.lang.InterruptedException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int num = FileFilterUtil.countFilesBySuffix("/home/rpark/test", ".java", "_my_");
