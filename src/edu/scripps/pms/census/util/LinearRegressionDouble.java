 ...
 * @author rpark
 */
public class LinearRegressionDouble {
    ...
    /** Creates a new instance of LinearRegressionDouble */
    public LinearRegressionDouble(double[] yArr, double[] xArr, int startIndex, int endIndex, int shift) {
        this.xArr = xArr;
        this.yArr = yArr;
