...
public class multihash
{
    ...
    int count=0;
    public List getProteinSet(String key)
    {
    ...
    public void display(Map<String,Peptide> peptide_data,ArrayList<String> tests,String directory)
    {
        
        String key=null;
        BufferedWriter bufferedWriter = null;
        Peptide data=new Peptide();
        try
        {
            //              c:/work/output_peptideAnalysis.txt
            if(directory == "")
                bufferedWriter = new BufferedWriter(new FileWriter("census-out-Tmtfilter.txt"));
            else
                bufferedWriter = new BufferedWriter(new FileWriter(directory+ File.separator+"census-out-Tmtfilter.txt"));//            System.out.println("Peptide \t Protine");
