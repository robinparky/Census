...
{
    private Map<String, Float> intensity = new HashMap<>();// The tests that are carried on the Peptide sequence. The key is the peptide sequence.
    ...
    public void setratio_avg()
    {
        ...
        getRatio_stdev()[0]=(float) stdev.getStandardDeviation();
        ...
        getRatio_stdev()[1]=(float) stdev.getStandardDeviation();
        sum=0;stdev=new DescriptiveStatistics();
        ar=ratio.get("2");
        it= ar.iterator();
        while(it.hasNext())
        ...
        getRatio_stdev()[2]=(float) stdev.getStandardDeviation();
    }
...
//    }
    ...
    /**
     * @param ratio_stdev the ratio_stdev to set
     */
    public void setRatio_stdev(float[] ratio_stdev) {
        this.ratio_stdev = ratio_stdev;
    }
}
