...
//	    MolWt = MWAccum;
	...
	public static float getMZFromPpm(float precMass, float tolerance) {

//tolerance is in ppm

    float mz = tolerance*precMass/1000000f;
    ...
    */
	...
	public static double getMZFromPpm(double precMass, double tolerance) {

//tolerance is in ppm

		double mz = tolerance*precMass/1000000f;
