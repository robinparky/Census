...
public class IsotopeDist15N extends IsotopeDist
{
...
//        abund[9][2] = (enrichment * 100) + (abund[9][0] * abund[2][2] / 100);
    ...
    public IsotopeDist15N(int[] element, double modShift, boolean isLight)
    {
	...
	//C, H, O, N, S, Ph, 15N, 2H, 13C
        ...
        IsotopeDist15N iso = new IsotopeDist15N(element, 0, false);
...
//System.out.println("light mass======" + mass);
