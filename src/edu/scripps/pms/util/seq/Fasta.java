/**
 * @file Fasta.java
 * This is the source file for com.ipa.ip2.util.spectrum.Fasta
 * @author Tao Xu
 * @author Robin Park
 * @date $Date: 2014/08/27 18:00:35 $
 */
...
//System.out.println("hahaha, defline: " + this.defline);
    ...
    public static String getAccessionWithNoVersion(String accession) {
    ...
    public static String getAccessionWithNoVersion() {
        int index = accession.indexOf(".");
        if(index == -1) {
            return accession;
        } else {
    ...
    public static String getAccession() {
        if(accession == null) {
...
//        accession = getDefline().substring( getDefline().indexOf('>')+1 );
        ...
        {
//	System.exit(1);
            //if((( accession.startsWith("gi") ||  accession.startsWith("tr") )&& accession.contains("|") )) //NCBI
            if( accession.startsWith("gi")) //NCBI
            {
...
*/
        ...
        System.out.println( "==>" + Fasta.getAccession("tr|H7C3X8|H7C3X8_HUMAN") + "<==");
